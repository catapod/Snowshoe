(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["AppComponents"] = factory();
	else
		root["AppComponents"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Components = exports.Actions = exports.Reducers = exports.Constants = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.uiKeys = exports.actionTypes = undefined;
	
	var _actionTypes = __webpack_require__(2);
	
	var actionTypes = _interopRequireWildcard(_actionTypes);
	
	var _uiKeys = __webpack_require__(3);
	
	var uiKeys = _interopRequireWildcard(_uiKeys);
...
/***/ function(module, exports) {
	...
	var ADD_TRANSLATION = exports.ADD_TRANSLATION = 'ADD_TRANSLATION';
	var REMOVE_TRANSLATION = exports.REMOVE_TRANSLATION = 'REMOVE_TRANSLATION';
	var UPDATE_TRANSLATION = exports.UPDATE_TRANSLATION = 'UPDATE_TRANSLATION';
	var VOTE_UP_TRANSLATE = exports.VOTE_UP_TRANSLATE = 'VOTE_UP_TRANSLATE';
	var VOTE_DOWN_TRANSLATE = exports.VOTE_DOWN_TRANSLATE = 'VOTE_DOWN_TRANSLATE';
	var COMMENT_TRANSLATE = exports.COMMENT_TRANSLATE = 'COMMENT_TRANSLATE';
...
/***/ function(module, exports) {
	...
	var ADD_TRANSLATION = exports.ADD_TRANSLATION = 'добавить перевод';
	var VOTE_UP = exports.VOTE_UP = '+1';
	var VOTE_DOWN = exports.VOTE_DOWN = '-1';
	var COMMENT_TRANSLATE = exports.COMMENT_TRANSLATE = 'комментировать';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sliceIds = __webpack_require__(5);
	
	Object.defineProperty(exports, 'sliceIds', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_sliceIds).default;
	  }
	});
	
	var _slices = __webpack_require__(6);
	
	Object.defineProperty(exports, 'slices', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_slices).default;
	  }
	});
	...
	Object.defineProperty(exports, 'translations', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_translations).default;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    switch (action.type) {
	        case _constants.actionTypes.ADD_TRANSLATION:
	            var sliceId = action.id;
	            var currentSlice = state[action.id];
	
	            return (0, _lodash.assign)({}, state, (0, _defineProperty3.default)({}, sliceId, (0, _lodash.assign)({}, currentSlice, {
	                translations: [].concat((0, _toConsumableArray3.default)(currentSlice.translations), [action.translateId])
	            })));
	        default:
	            return state;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    switch (action.type) {
	        case _constants.actionTypes.ADD_TRANSLATION:
	            return (0, _lodash.assign)({}, state, (0, _defineProperty3.default)({}, action.translateId, Translation(action)));
	        default:
	            return state;
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _translateActions = __webpack_require__(69);
	
	Object.keys(_translateActions).forEach(function (key) {
	  if (key === "default") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _translateActions[key];
	    }
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.removeTranslate = removeTranslate;
	exports.updateTranslate = updateTranslate;
	exports.voteTranslateUp = voteTranslateUp;
	exports.voteTranslateDown = voteTranslateDown;
	exports.commentTranslate = commentTranslate;
	...
	function addTranslate(id, text) {
	    var translateId = (0, _lodash.uniqueId)();
	    return {
	        type: _constants.actionTypes.ADD_TRANSLATION,
	        id: id,
	...
	function removeTranslate(id, translateId) {
	    return {
	        type: _constants.actionTypes.REMOVE_TRANSLATION,
	        id: id,
	        translateId: translateId
	    };
	}
	
	function updateTranslate(id, translateId, text) {
	    return {
	        type: _constants.actionTypes.UPDATE_TRANSLATION,
	        id: id,
	        translateId: translateId,
	        text: text
	    };
	...
	function voteTranslateUp(translateId) {
	    return {
	        type: _constants.actionTypes.VOTE_UP_TRANSLATE,
	        translateId: translateId
	    };
	}
	
	function voteTranslateDown(translateId) {
	    return {
	        type: _constants.actionTypes.VOTE_DOWN_TRANSLATE,
	        translateId: translateId
	    };
	}
	
	function commentTranslate(translateId) {
	    return {
	        type: _constants.actionTypes.COMMENT_TRANSLATE,
	        translateId: translateId
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TranslationControls = exports.TranslationArea = exports.SliceTranslationsList = exports.SliceList = undefined;
	
	var _sliceList = __webpack_require__(71);
	
	var _sliceList2 = _interopRequireDefault(_sliceList);
	
	var _sliceTranslationsList = __webpack_require__(129);
	
	var _sliceTranslationsList2 = _interopRequireDefault(_sliceTranslationsList);
	
	var _translationArea = __webpack_require__(132);
	
	var _translationArea2 = _interopRequireDefault(_translationArea);
	
	var _translationControls = __webpack_require__(135);
	
	var _translationControls2 = _interopRequireDefault(_translationControls);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.SliceList = _sliceList2.default;
	exports.SliceTranslationsList = _sliceTranslationsList2.default;
	exports.TranslationArea = _translationArea2.default;
	exports.TranslationControls = _translationControls2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sliceList = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDebugTool = __webpack_require__(90);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapActionCreators = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combineReducers = __webpack_require__(121);
	
	var _combineReducers2 = _interopRequireDefault(_combineReducers);
	
	var _bindActionCreators = __webpack_require__(123);
	
	var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);
	
	var _applyMiddleware = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(116),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(120)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    var sliceIds = _ref.sliceIds;
	    var slices = _ref.slices;
	    return _react2.default.createElement(
	        'div',
	        { className: 'slice-list' },
	        sliceIds.map(function (id) {
	            return _react2.default.createElement(
	                'div',
	                { className: 'slice-list__row' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'slice-list__cell' },
	                    slices[id].text
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'slice-list__cell' },
	                    _react2.default.createElement(_sliceTranslationsList2.default, { sliceId: id })
	                )
	            );
	        })
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sliceTranslationsList = __webpack_require__(131);
	...
	})(_sliceTranslationsList2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'slice-translations-list' },
	        slice.translations.map(function (id) {
	            return _react2.default.createElement(
	                'div',
	                { className: 'slice-translations-list__item' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'slice-translations-list__text' },
	                    translations[id].text
	                ),
	                _react2.default.createElement(_translationControls2.default, { className: 'slice-translations-list__controls', translateId: id })
	            );
	        }),
	        _react2.default.createElement(_translationArea2.default, { sliceId: slice.id })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _translationArea = __webpack_require__(134);
	...
	exports.default = (0, _reactRedux.connect)(null, {
	    addTranslate: _translateActions.addTranslate
	})(_translationArea2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    var sliceId = _ref.sliceId;
	    var addTranslate = _ref.addTranslate;
	    var addButtonText = _ref.addButtonText;
	
	    var textArea = void 0;
	    var onAddClick = function onAddClick(event) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement('textarea', { ref: function ref(c) {
	                return textArea = c;
	            },
	        ...
	        _react2.default.createElement(
	            'a',
	            { className: 'translation-area__submit', href: '#', onClick: onAddClick },
	            addButtonText || _constants.uiKeys.ADD_TRANSLATION
	        )
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _translationControls = __webpack_require__(136);
	...
	exports.default = (0, _reactRedux.connect)(null, {
	    voteTranslateUp: _translateActions.voteTranslateUp,
	    voteTranslateDown: _translateActions.voteTranslateDown,
	    commentTranslate: _translateActions.commentTranslate
	})(_translationControls2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    ...
	    var translateId = _ref.translateId;
	    var voteTranslateUp = _ref.voteTranslateUp;
	    var voteTranslateDown = _ref.voteTranslateDown;
	    var commentTranslate = _ref.commentTranslate;
	    var voteUpText = _ref.voteUpText;
	    var voteDownText = _ref.voteDownText;
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: (0, _classNames2.default)('translation-controls', className) },
	        _react2.default.createElement(
	            'a',
	            { className: 'translation-controls__item', href: '#', onClick: handle(voteTranslateUp) },
	            voteUpText || _constants.uiKeys.VOTE_UP
	        ),
	        ', ',
	        _react2.default.createElement(
	            'a',
	            { className: 'translation-controls__item', href: '#', onClick: handle(voteTranslateDown) },
	            voteDownText || _constants.uiKeys.VOTE_DOWN
	        ),
	        ', ',
	        _react2.default.createElement(
	            'a',
	            { className: 'translation-controls__item', href: '#', onClick: handle(commentTranslate) },
	            commentText || _constants.uiKeys.COMMENT_TRANSLATE
	        )
	    );
	};
